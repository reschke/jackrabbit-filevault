...
public class DocViewSAXHandler extends RejectingEntityDefaultHandler implements NamespaceResolver {
   ...
   private final DefaultNamePathResolver npResolver = new DefaultNamePathResolver(this);
    ...
    private boolean hasVisitedFirstElement = false;
    ...
    /** 
     * Extracts the index and the original item name from a name according to <a href="https://docs.adobe.com/content/docs/en/spec/jcr/2.0/22_Same-Name_Siblings.html#22.2%20Addressing%20Same-Name%20Siblings%20by%20Path>JCR 2.0 22.2</a>
     * @param name
     * @return
     */
    ...
    public void startElement(final String uri, final String localName, final String qName, final Attributes attributes) throws SAXException {
        ...
        if (!hasVisitedFirstElement
            ...
            if (rootNodePath.isEmpty()) {
                ...
                try {
                    ...
                    throw new SAXException("Invalid name space", e);
                }
            }
        } else {
        ...
        try {
            ...
            // TODO: path
            handler.startDocViewNode(null, ni);
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        log.trace("<- element {}", qName);
        try {
            handler.endDocViewNode(qName, null);
        } catch (RepositoryException|IOException e) {
            throw new SAXException(e);
        }
    }
