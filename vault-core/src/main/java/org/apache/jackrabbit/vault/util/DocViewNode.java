...
public class DocViewNode {
    ...
    public static DocViewNode fromDocViewNode2(DocViewNode2 docViewNode2) {
        // 
        String label = docViewNode2.getName().toString();
        if (docViewNode2.getIndex() > 0) {
            label += "[" + docViewNode2.getIndex() + "]";
        }
        //docViewNode2.getProperties().stream()
        //new DocViewNode(docViewNode2.getName().toString(), label, docViewNode2.getIdentifier().orElse(null));
        return null;
    }
